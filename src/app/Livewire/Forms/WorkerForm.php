...
class WorkerForm extends Form
{
    ...
    protected function rules(): array
    {
        return [
            ...
            'position' => [
                'required',
                'string',
                'in:GERENTE,ENCARGADO,SECRETARIA,ENFERMERA,VENDEDOR,SUPERVISOR,OTRO',
            ],
            'clinic_id' => [
                'required',
    ...
    public function messages(): array
    {
        return [
            ...
            'hired_at.required' => __('validation.birth_date.required'),
            'hired_at.date' => __('validation.birth_date.date'),
            'hired_at.before_or_equal' => __('validation.birth_date.before'),
